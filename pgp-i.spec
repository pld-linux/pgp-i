...
Summary(pl):	PGP - narzÍdzia do kodowania danych i poczty elektronicznej
Name:		pgp
Version:	5.0i
Release:	3
...
%description -l pl
Pakiet zawiera pgp - aplikacjÍ, ktÛra jest defacto standardem dla
kodowania poczty elektronicznej (email), jak rÛwnieø moøe byÊ uøywana
do kodowania danych.
